import 'dart:io'; // Файлды жүктеу үшін

import 'package:flutter/material.dart'; // Материал дизайн үшін
import 'package:image_picker/image_picker.dart'; // Суретті таңдау үшін

import 'package:firebase_storage/firebase_storage.dart'; // Firebase жадындағы файлдарды сақтау үшін
import 'package:cloud_firestore/cloud_firestore.dart'; // Firestore-ды қолдану үшін

import 'package:firebase_auth/firebase_auth.dart'; // Firebase Auth үшін
import 'package:path/path.dart' as Path; // Path пакетін қолдану үшін

import 'package:oryntapp/language/language_constants.dart'; // Тілді ауыстыру үшін
import 'package:oryntapp/language/language.dart'; // Тілді ауыстыру үшін

import '../main.dart'; // Басты бет
...
class _AccountScreenState extends State<AccountScreen> {
  final currentUser = FirebaseAuth.instance.currentUser; // Ағымдағы пайдаланушы
  final userCollection = FirebaseFirestore.instance.collection("Users"); // Пайдаланушылар тізімі
